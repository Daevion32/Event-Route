...
@section('content')
                ...
                <div class="col-md-8">
                    <div class="container_title">
                        ...
                        <form action="{{ route('delete',['id'=> $event->id])}}" method="post">
                                        ...
                                        @csrf
                                        <a type="button" 
                                            onclick="return confirm ('¿Estás seguro de querer eliminar este Evento? {{$event->name}}')">
                    ...
                    <div class="space-x-2 flex  container_spaces">
                        ...
                        <button id="inscriptionButton" class="h-10 px-6 font-semibold rounded-md bg-red text-white button_add" type="submit"><a href="{{ route('inscribe', $event->id)}}"
                            >Inscribete</a></button>
    ...
    @if(Auth::check() && Auth::user()->isAdmin)                                  
        <button class="btn btn-primary btn-padding-y">
            <a  style="color: white" href="{{route('createEvent')}}">
                Nuevo Evento
            </a>
        </button>
    @endif
