...
<a href="{{route('createEvent')}}">
            <input class="btn btn-dark btn-padding-y" id="addNewEvent" type=submit" value="Nuevo Evento">
        </a>
                                                            ...
                                                            <div class="container_title">
                                                                ...
                                                                <div class="icon_title">
                                                                    ...
                                                                    <form action="{{ route('delete',['id'=> $event->id])}}" method="post">
                                                                        @method('delete')
                                                                        @csrf
                                                                        <a type="submit" onclick="return confirm ('¿Estas seguro de querer eliminar este Evento? {{$event->name}}')">
