...
<<<<<<< HEAD
                    <button method="post"  class="btn btn-warning button_add" type="submit">
...
>>>>>>> 15a783efb235f6f8bde5c9d4d3852f583b8a93ab
                    </button>
                    @if(Auth::check() && Route::has('inscribe'))
...
<div class="container_cards ">
    ...
    <div class="card text-bg-dark mb-3 card_all" style="max-width: 540px;">
        <div class="row g-0 opacity-25">
            ...
            <div class="col-md-8">
                <div class="container_title">
                    <h1 class="card-title">{{ $event->name}} <br><br><span class=" p-1 bg-danger text-white">No Disponible</span></h1>
                    @if(Auth::check() && Auth::user()->isAdmin)
                    <div class="icon_title">
                        <a id=“editButton” href="{{ route('editEvent', ['id' => $event->id]) }}">
                            <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
