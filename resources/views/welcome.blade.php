...
<>
    ...
    <body class="antialiased">
        ...
        <section>
            ...
            <h5>Capacidad:{{$event->spaces}}</h5>
//@if ($event-> spaces <= 0){}
            <form action="{{ route('delete', ['id' => $event->id]) }}" method="post">
            @method('delete')
            @csrf
            <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this event? {{$event->name}}')">Delete</button>
        </form>
        </section>
    </body>
</html>
